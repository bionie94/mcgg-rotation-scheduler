  ...
  for (let i = 1; i <= 8; i++) {
    ...
    wrapper.innerHTML = `
      ...
      <input id="P${i}" type="text"
             class="px-3 py-2 rounded bg-gray-700 border border-gray-600 placeholder-gray-500 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
...
function solve() {
  ...
  // Kemungkinan 2 (swap order remaining)
  let seq2 = [];
  titles.forEach((title, idx) => {
    if (idx < chosen.length) {
